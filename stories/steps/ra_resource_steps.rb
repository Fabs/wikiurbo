...
steps_for(:ra_resource) do
  ...
  #   "Given a citizen with login: 'mojojojo'" 
  # produces a Citizen instance stored in @citizen with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the citizen has thac0: 3"
  # takes the earlier-defined @citizen instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'citizen'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Citizen model in the @citizen instance variable.
#
