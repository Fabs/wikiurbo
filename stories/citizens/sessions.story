...
Story: Logging in
  As an anonymous citizen with an account
  ...
  # Log in: get form
  #
  Scenario: Anonymous citizen can get a login form.
  ...
  #
  Scenario: Anonymous citizen can log in
    Given an anonymous citizen
  ...
  Scenario: Logged-in citizen who logs in should be the new one
    Given an activated citizen named 'reggie'
     And  an activated citizen logged in as 'oona'
    When  she creates a singular sessions with login: 'reggie', password: 'monkey', remember me: ''
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'Logged in successfully'
  ...
  #
  Scenario: Anonymous citizen can log in and be remembered
    Given an anonymous citizen
     And  an activated citizen named 'reggie'
    ...
    Then  she should see a notice message 'Logged in successfully'
     ...
     And  her session store should have citizen_id: 4
   
  #
  # Log in unsuccessfully
  #
  
  Scenario: Logged-in citizen who fails logs in should be logged out
    Given an activated citizen named 'oona'
    ...
    Then  she should see an error message 'Couldn't log you in as 'reggie''
     ...
     And  she should not have an auth_token cookie
     And  her session store should not have citizen_id
  ...
  #
  Scenario: Anonymous (logged out) citizen can log out.
    Given an anonymous citizen
  ...
  Scenario: Logged in citizen can log out.
    Given an activated citizen logged in as 'reggie'
    When  she goes to /logout
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'You have been logged out'
