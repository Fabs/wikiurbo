...
Story: Creating an account
  ...
  #
  Scenario: Anonymous citizen can start creating an account
    Given an anonymous citizen
    When  she goes to /signup
    Then  she should be at the 'citizens/new' page
  ...
  # Account Creation
  #
  Scenario: Anonymous citizen can create an account
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
    ...
    Then  she should see a notice message 'Thanks for signing up!'
     And  a citizen with login: 'oona' should exist
     And  the citizen should have login: 'oona', and email: 'unactivated@example.com'

     And  the citizen's activation_code should not be nil
     And  the citizen's activated_at    should     be nil
  ...
  Scenario: Anonymous citizen can not create an account replacing a non-activated account
    Given an anonymous citizen
     And  a registered citizen named 'Reggie'
     And  the citizen has activation_code: 'activate_me', activated_at: nil! 
     And  we try hard to remember the citizen's updated_at, and created_at
    ...
    Then  she should be at the 'citizens/new' page
     ...
     And  a citizen with login: 'reggie' should exist
     And  the citizen should have email: 'registered@example.com'
     And  the citizen's activation_code should not be nil
     And  the citizen's activated_at    should     be nil
     And  the citizen's created_at should stay the same under to_s
     And  the citizen's updated_at should stay the same under to_s
     And  she should not be logged in
     
  Scenario: Anonymous citizen can not create an account replacing an activated account
    Given an anonymous citizen
     And  an activated citizen named 'Reggie'
     And  we try hard to remember the citizen's updated_at, and created_at
    ...
    Then  she should be at the 'citizens/new' page
     ...
     And  the citizen's activation_code should     be nil
     And  the citizen's activated_at    should not be nil
     And  the citizen's created_at should stay the same under to_s
     And  the citizen's updated_at should stay the same under to_s
     And  she should not be logged in
  ...
  #
  Scenario: Anonymous citizen can not create an account with incomplete or incorrect input
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
    ...
    Then  she should be at the 'citizens/new' page
     ...
     And  no citizen with login: 'oona' should exist
     
  Scenario: Anonymous citizen can not create an account with no password
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
  ...
  Scenario: Anonymous citizen can not create an account with no password_confirmation
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
  ...
  Scenario: Anonymous citizen can not create an account with mismatched password & password_confirmation
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
  ...
  Scenario: Anonymous citizen can not create an account with bad email
    Given an anonymous citizen
     And  no citizen with login: 'Oona' exists
...
Story: Activating an account
  As a registered, but not yet activated, citizen
  ...
  #
  Scenario: Not-yet-activated citizen can activate her account
    Given a registered citizen named 'Reggie'
     And  the citizen has activation_code: 'activate_me', activated_at: nil! 
     And  we try hard to remember the citizen's updated_at, and created_at
    ...
    Then  she should see a notice message 'Signup complete!'
     And  a citizen with login: 'reggie' should exist
     And  the citizen should have login: 'reggie', and email: 'registered@example.com'
     And  the citizen's activation_code should     be nil
     And  the citizen's activated_at    should not be nil
     And  she should not be logged in
  ...
  #
  Scenario: Not-yet-activated citizen can't activate her account with a blank activation code
    Given a registered citizen named 'Reggie'
     And  the citizen has activation_code: 'activate_me', activated_at: nil! 
     And  we try hard to remember the citizen's updated_at, and created_at
    ...
    Then  she should see an error  message 'activation code was missing'
     And  a citizen with login: 'reggie' should exist
     And  the citizen should have login: 'reggie', activation_code: 'activate_me', and activated_at: nil!
     And  the citizen's updated_at should stay the same under to_s
     And  she should not be logged in
  
  Scenario: Not-yet-activated citizen can't activate her account with a bogus activation code
    Given a registered citizen named 'Reggie'
     And  the citizen has activation_code: 'activate_me', activated_at: nil! 
     And  we try hard to remember the citizen's updated_at, and created_at
    ...
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see an error  message 'couldn\'t find a citizen with that activation code'
     And  a citizen with login: 'reggie' should exist
     And  the citizen should have login: 'reggie', activation_code: 'activate_me', and activated_at: nil!
     And  the citizen's updated_at should stay the same under to_s
     And  she should not be logged in
